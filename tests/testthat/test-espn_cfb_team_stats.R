...
test_that("ESPN CFB Team Stats", {
  ...
  cols <- c(
    ...
    "general_total_penalties",
    "general_total_penalty_yards",
    "passing_avg_gain",
    ...
    "defensive_missed_field_goal_return_td",
    "defensive_blocked_punt_ez_rec_td",
    ...
    "scoring_kick_extra_points_made",
    "scoring_misc_points",
  ...
  x <- espn_cfb_team_stats(2020, team_id = 57)

  y <- espn_cfb_team_stats(2020, team_id = 52)

  # Subset direction: hard-coded `cols` is the contract we expect to
  # appear in the response; ESPN regularly appends new fields
  # (logos_alt_*, general_fumbles_forced_primary, etc.), so strict
