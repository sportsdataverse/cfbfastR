...
test_that("CFB Rushing Teams Season", {
  skip_on_cran()
  skip_if_not(has_cfbd_key(), "CFBD_API_KEY not set")
  x <- cfbd_rushing_teams_season(year = 2025, team = "Texas")
  ...
  # offense and once for rushing allowed. Losing one side would silently halve
