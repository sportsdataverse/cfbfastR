...
test_that("ESPN CFB Player Season Statistics", {
  skip_on_cran()

  cols <- c(
    "athlete_id", "season", "season_type", "category", "category_display",
    "stat_name", "display_name", "abbreviation", "description", "value",
    "display_value", "per_game_value", "per_game_display_value"
  )
