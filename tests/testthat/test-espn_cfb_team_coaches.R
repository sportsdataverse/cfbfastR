...
test_that("ESPN CFB Team Coaches", {
  ...
  x <- espn_cfb_team_coaches(team_id = 61, year = 2024)

  y <- espn_cfb_team_coaches(team_id = 61, year = 2023)
  ...
  z <- espn_cfb_team_coaches(team_id = 61, year = 2024, team_detail = FALSE)
