...
#' @return [cfbd_player_portal()] - A data frame with 11 variables:
#' \describe{
#'   \item{`athlete_id`:integer}{Unique player identifier `athlete_id`.}
...
#' @examples
#' \donttest{
#' cfbd_player_portal(year = 2021)
#' }
cfbd_player_portal <- function(year) {
