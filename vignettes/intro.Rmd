...
```{r load_cfbfastR_tidy, echo=FALSE}
...
## **The fastR way**: `load_cfb_pbp()` (19 seasons, \~1-1.5 minutes `r emo::ji("flame")`)

We are going to load in data for seasons 2002-2020, it'll take between 120-180 seconds to run.
