...
Using the [load_cfb_pbp()](https://saiemgilani.github.io/cfbfastR/reference/load_cfb_pbp.html) method, we will pull down a dataframe that contains ALL of the play by play data for ALL teams in `r cfbfastR:::most_recent_season()`. This method only takes about 30 seconds.
...
```{r cfbd_teams_info}
team_info = cfbfastR::cfbd_team_info(year = yr)
