...
```{r graph_top_offenses, fig.height=8, fig.width=6, fig.align="center", fig.alt="Offensive EPA Per Play | Positive EPA Teams"}
off_epa |>
  filter(off_epa > 0) |>
...
```{r graph_the_graph, fig.width=7, fig.height=6, fig.align="center", fig.alt="Offensive EPA Rolling Average", warning=FALSE}
