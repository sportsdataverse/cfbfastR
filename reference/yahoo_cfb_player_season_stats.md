...
#> ℹ Data updated: 2026-06-12 03:21:04 UTC
#> # A tibble: 191 × 88
...
#> # ℹ 181 more rows
#> # ℹ 83 more variables: field_goal_attempts_50_plus <chr>,
#> #   passing_completions <chr>, passing_touchdowns <chr>,
#> #   field_goal_attempts_0_19 <chr>, punt_yards <chr>,
#> #   kickoff_return_touchdowns <chr>, forced_fumbles <chr>,
#> #   longest_punt_return <chr>, qb_rating <chr>, field_goals_made <chr>,
#> #   rushing_attempts_per_game <chr>, sacks_yards <chr>, games_passing <chr>, …
# }
```
