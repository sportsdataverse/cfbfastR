...
#> ℹ Data updated: 2026-06-12 13:15:52 UTC
#> # A tibble: 191 × 88
...
#> # ℹ 181 more rows
#> # ℹ 83 more variables: kickoff_return_yards <chr>, field_goal_percentage <chr>,
#> #   passing_yards_per_game <chr>, field_goals_40_to_49 <chr>,
#> #   extra_point_percentage <chr>, receiving_yards_per_game <chr>,
#> #   longest_rush <chr>, passing_attempts <chr>, qb_rating <chr>,
#> #   kickoff_return_touchdowns <chr>, longest_punt <chr>,
#> #   field_goal_attempts_50_plus <chr>, punt_yards_per_punt <chr>, …
# }
```
