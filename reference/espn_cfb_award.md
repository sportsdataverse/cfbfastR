...
- year:
  ...
  (*Integer* required): Season, 4 digit format (*YYYY*). Minimum value
  accepted: 1935
...
#> ── Award detail from ESPN ─────────────────────────────── cfbfastR 3.0.0.9000 ──
#> ℹ Data updated: 2026-09-01 11:25:14 UTC
#> # A tibble: 1 × 20
...
#> ── Award detail from ESPN ─────────────────────────────── cfbfastR 3.0.0.9000 ──
#> ℹ Data updated: 2026-09-01 11:25:15 UTC
#> # A tibble: 1 × 10
