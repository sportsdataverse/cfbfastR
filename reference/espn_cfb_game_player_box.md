...
#> ── Game player box score data from ESPN ────────────────────── cfbfastR 3.0.0 ──
#> ℹ Data updated: 2026-08-24 13:31:07 UTC
#> # A tibble: 6,083 × 33
...
#> ── Game player box score data from ESPN ────────────────────── cfbfastR 3.0.0 ──
#> ℹ Data updated: 2026-08-24 13:31:12 UTC
#> # A tibble: 6,083 × 28
#>    game_id   team_id team_name team_abbreviation team_location team_display_name
#>    <chr>     <chr>   <chr>     <chr>             <chr>         <chr>            
#>  1 401628339 61      Bulldogs  UGA               Georgia       Georgia Bulldogs 
...
#> #   category_summary <chr>, stat_name <chr>, abbreviation <chr>, …
  try(espn_cfb_game_player_box(game_id = 401628339,
                               team_detail = FALSE))
#> ── Game player box score data from ESPN ────────────────────── cfbfastR 3.0.0 ──
#> ℹ Data updated: 2026-08-24 13:31:17 UTC
#> # A tibble: 6,083 × 23
