...
| yahoo_global_game_id | character | Yahoo's cross-season global game key in ncaaf.g. form, distinct from the date-encoded yahoo_game_id. |
| home_team | character |  |
| away_team | character |  |
...
#> ℹ Data updated: 2026-08-24 12:13:07 UTC
#> # A tibble: 1,629 × 11
