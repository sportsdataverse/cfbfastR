...
to-date EPA and success-rate profiles. Published to the
`cfb_team_summaries_weekly` release tag on the sportsdataverse-data
repo.
...
#> ℹ Data updated: 2026-08-27 16:44:24 UTC
#> # A tibble: 1,585 × 384
