...
#> ℹ Data updated: 2026-09-19 02:52:50 UTC
#> # A tibble: 26 × 78
...
#>  3 401403885 LSU        SEC        home      Mississ… SEC                     31
#>  4 401403885 Mississip… SEC        away      LSU      SEC                     16
...
#>  9 401403963 LSU        SEC        away      Texas A… SEC                     23
#> 10 401403963 Texas A&M  SEC        home      LSU      SEC                     38
#> # ℹ 16 more rows
...
#> ── Team stats data from CollegeFootballData.com ───────── cfbfastR 3.0.0.9000 ──
#> ℹ Data updated: 2026-09-19 02:52:51 UTC
#> # A tibble: 26 × 78
#>      game_id school     conference home_away opponent opponent_conference points
#>        <int> <chr>      <chr>      <chr>     <chr>    <chr>                <int>
