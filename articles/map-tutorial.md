...
```
    ...
    ##  $ height                 : num [1:3364] 75 72 77 76 78 ...
    ##  $ weight                 : int [1:3364] 206 190 240 265 305 200 277 180 248 283 ...
    ##  $ stars                  : int [1:3364] 5 3 3 5 5 3 5 3 5 5 ...
    ...
    ##  - attr(*, "cfbfastR_timestamp")= POSIXct[1:1], format: "2026-09-10 06:00:36"
